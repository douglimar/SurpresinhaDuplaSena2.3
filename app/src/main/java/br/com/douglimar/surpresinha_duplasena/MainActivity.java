...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnOpenGooglePlay = findViewById(R.id.btnGoogleApps);
        ...
        btnJogoUnico.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent2.putExtra(MainActivity.EXTRA_MESSAGE2, surpresinha.generateDuplaSenaGame());
    ...
    private void carregaWebView() {
        ...
        intent.putExtra("URL", "http://www.loterias.caixa.gov.br/wps/portal/loterias/landing/duplasena");
